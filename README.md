...
![Topology](images/config_vlan_topology.png)
...
![create interface vlan](images/create_vlan_interface.png)
![vlans](images/after_create_vlans_interfaces.png)
...
![connect via neighbor](images/connect_to_access_router.png)
...
![vlan filtering interface](images/vlan_filtering_on_interface.png)
![vlan filtering bridge](images/vlan_filtering_bridge.png)
![vlans config](images/vlan_bridge_configuration.png)
...
![ping google dns server](images/ping_google_from_vpcs.png)
